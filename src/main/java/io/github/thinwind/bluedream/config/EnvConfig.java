...
public class EnvConfig {
    ...
    public EnvConfig(String traceIdPrefix) {
        this.traceIdPrefix = traceIdPrefix;
    }

    private static final AtomicLong FAKE_TRACE_ID_GENERATOR = new AtomicLong(System.currentTimeMillis());

    public String createTraceId() {
        return traceIdPrefix + String.valueOf(FAKE_TRACE_ID_GENERATOR.getAndIncrement()) + "@" + host;
    }
}
